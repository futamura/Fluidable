...
canonical store は repo 内 `.agents/memory/`。Claude Code 側の project auto memory path は、この directory への symlink として扱う。Codex は Claude Code の自動 memory 読み込みを前提にせず、本ファイルと関連 memory を明示的に読む。
...
- [x] **#1 Repository guidelines 初期作成** — 2026-05-19 / `AGENTS.md`, `CLAUDE.md`, `CODING-GUIDE.md`, project memory を作成。
